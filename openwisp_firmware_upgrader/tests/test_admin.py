...
from ..models import DeviceFirmware, UpgradeOperation
from .base import TestUpgraderMixin

User = get_user_model()


class TestAdmin(TestUpgraderMixin, TestCase):
    ...
    def test_upgrade_related(self):
        ...
        fw = DeviceFirmware.objects.filter(image__build_id=env['build2'].pk) \
