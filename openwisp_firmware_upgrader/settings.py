...
PERSISTENT_RETRY_BASE_DELAY = getattr(
    settings, "OPENWISP_FIRMWARE_UPGRADER_PERSISTENT_RETRY_BASE_DELAY", 600
)
PERSISTENT_RETRY_MULTIPLIER = getattr(
    settings, "OPENWISP_FIRMWARE_UPGRADER_PERSISTENT_RETRY_MULTIPLIER", 2
)
PERSISTENT_RETRY_JITTER = getattr(
    settings, "OPENWISP_FIRMWARE_UPGRADER_PERSISTENT_RETRY_JITTER", 0.25
)
PERSISTENT_RETRY_MAX_DELAY = getattr(
    settings, "OPENWISP_FIRMWARE_UPGRADER_PERSISTENT_RETRY_MAX_DELAY", 43200
)
CHECK_PENDING_UPGRADES_PERIOD = getattr(
    settings, "OPENWISP_FIRMWARE_UPGRADER_CHECK_PENDING_UPGRADES_PERIOD", 600
)
PERSISTENT_RETRY_DISPATCH_JITTER = getattr(
    settings, "OPENWISP_FIRMWARE_UPGRADER_PERSISTENT_RETRY_DISPATCH_JITTER", 300
)
